...
## 示例
[下载](https://github.com/duiniuluantanqin/HevcPlayerPlugin/releases/download/v0.1.2/HevcPlayerPlugin.Setup-0.1.4.exe)已经编译好的Windows二进制文件，安装后打开测试页面，路径在程序安装目录下`player/index.html`。
<br>
