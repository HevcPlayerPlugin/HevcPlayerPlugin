...
#define FFMPEG_CONFIGURATION "--prefix=./build --enable-gpl --enable-shared --enable-version3 --disable-avdevice --disable-postproc --disable-avfilter --disable-swresample --disable-muxers --disable-encoders --disable-protocols --enable-protocol=rtmp --enable-protocol=hls --enable-protocol=http --enable-protocol=https --enable-protocol=file --enable-dxva2 --enable-d3d11va --toolchain=msvc"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "./build/share/ffmpeg"
#define AVCONV_DATADIR "./build/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.31.31105 for x86"
