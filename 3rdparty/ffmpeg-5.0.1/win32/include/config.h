...
#define FFMPEG_CONFIGURATION "--prefix=./build --enable-gpl --enable-shared --enable-version3 --disable-avdevice --disable-postproc --disable-avfilter --disable-muxers --disable-encoders --disable-protocols --enable-protocol=rtmp --enable-protocol=hls --enable-protocol=http --enable-protocol=https --enable-protocol=file --enable-dxva2 --toolchain=msvc"
